# sdkwork-assets Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-assets` |
| `runtimeCode` | `assets` |
| Config root | `/etc/sdkwork/assets/` |
| Runtime TOML | `/etc/sdkwork/assets/config.toml` |
| Secrets | `/etc/sdkwork/assets/secrets/` |
| Override | `SDKWORK_ASSETS_CONFIG_FILE` |
